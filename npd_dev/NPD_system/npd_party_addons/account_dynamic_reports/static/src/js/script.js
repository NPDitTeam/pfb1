        ...
        print_pdf: function(e) {
            ...
            self._rpc({
                ...
                var action = {
                    'type': 'ir.actions.report',
                    'report_type': 'qweb-pdf',
                    'report_name': 'account_dynamic_reports.advance_ageing',
                    'report_file': 'account_dynamic_reports.advance_ageing',
                    'data': {
                        'js_data': data
                    },
                    'context': {
                        'active_model': 'ins.advance.ageing',
                        'landscape': 1,
                        'from_js': true
                    },
                    'display_name': 'Advance Ageing',
                };
                return self.do_action(action);
            });
        },
...
//                    });
                    ...
                    self.$el.find('.employees-multiple').select2({
...
//                    });
                ...
                self.$('.py-data-container-orig').html(QWeb.render('DataSectionAv', {
                    ageing_data: self.ageing_data,
                    period_dict: self.period_dict,
                    period_list: self.period_list
                }));
    ...
    core.action_registry.add('dynamic.av', DynamicAvMain);
});