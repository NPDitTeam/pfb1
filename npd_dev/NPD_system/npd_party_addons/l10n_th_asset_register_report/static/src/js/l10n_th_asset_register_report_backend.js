odoo.define('l10n_th_asset_register_report.l10n_th_asset_register_report_backend', function (require) {
    'use strict';
...
//  var ControlPanelMixin = require('web.ControlPanelMixin');
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            'click .o_l10n_th_asset_register_reports_print': 'print',
            'click .o_l10n_th_asset_register_reports_export': 'export',
        },
    ...
    core.action_registry.add(
        "l10n_th_asset_register_report_backend",
        report_backend
    );
