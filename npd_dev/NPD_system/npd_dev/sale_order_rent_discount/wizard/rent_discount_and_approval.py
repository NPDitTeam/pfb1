...
# ----------------------------
# Wizard: ส่วนลดค่าเช่า
# ----------------------------
class RentDiscountWizard(models.TransientModel):
    _name = 'rent.discount.wizard'
    _description = 'Wizard for Rental Discount'

    discount_amount = fields.Float(string="จำนวนเงินที่จะลด", required=True)

    @api.model
    def default_get(self, fields_list):
        res = super(RentDiscountWizard, self).default_get(fields_list)
