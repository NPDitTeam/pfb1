...
class AssetMove(models.Model):
    _name = "asset.move"
    _description = "การเคลื่อนย้ายทรัพย์สิน"

    name = fields.Char(string="ชื่อการเคลื่อนย้าย")
    location_id = fields.Many2one(comodel_name="asset.location", string="สถานที่ต้นทาง")
    location_dest_id = fields.Many2one(comodel_name="asset.location", string="สถานที่ปลายทาง")
    asset_id = fields.Many2one(comodel_name="asset.detail", string="ทรัพย์สิน")
