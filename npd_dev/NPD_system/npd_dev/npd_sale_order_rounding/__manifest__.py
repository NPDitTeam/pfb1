...
- เลือกขั้นการปัด (step) แบบ preset (0.05 / 0.10 / 0.25 / 0.50 / 1.00)
- หรือเลือก "กำหนดเอง" เพื่อปรับยอดรวมเป็นจำนวนเงินอิสระ ใส่ค่าบวกเพื่อเพิ่ม ค่าลบเพื่อลด (เช่น -0.01)
