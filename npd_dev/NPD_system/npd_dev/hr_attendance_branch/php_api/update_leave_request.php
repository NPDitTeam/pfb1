<?php
// อัพเดทเรคคอร์ดในตาราง leave_requests (เรียกจาก Odoo ตอนกดแก้ไข)
...
// หมายเหตุ: เวลาเริ่มต้นใน DB สะกดเป็น 'leave_statr_time'
$allowed_columns = [
    'user_id',
    'username',
    'leave_start_date',
...
try {
    ...
    // สร้างชุดคอลัมน์ที่จะอัพเดทจาก whitelist เท่านั้น
    $set_parts = [];
    $params = [];
    ...
    $sql = "UPDATE leave_requests SET " . implode(', ', $set_parts) . " WHERE id = ?";
