odoo.define("npd_tax_report_payment_backend", function (require) {
    "use strict";
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            "click .o_npd_tax_report_payment_print": "print_report",
            "click .o_npd_tax_report_payment_export": "export_report",
            "click .o_npd_tax_report_payment_export_test_excel": "export_test_excel_report",
        },
        ...
        export_test_excel_report: function () {
            ...
            framework.blockUI();
            this._rpc({
                model: 'tax.payment.report.wizard',
                method: 'create',
    ...
    ActionManager.include({
        _executeClientAction: function (action) {
            if (action.tag === 'download_report_binary') {
                ...
                var downloadUrl = window.location.origin + '/npd_tax_report_payment/download_binary_file_post';
    ...
    core.action_registry.add("npd_tax_report_payment_backend", report_backend);
