{
    'name': 'ใบแจ้งหนี้/ใบวางบิล - ติดตามหนี้บ้านเขียว',
    'version': '14.0.2.3.0',
    'summary': 'รายงานใบแจ้งหนี้/ใบวางบิล สำหรับติดตามหนี้บ้านเขียว (ค่าเช่า/ค่าปรับชำรุด/ค่าปรับหาย/ค่า Tax)',
    'description': "",
    'author': 'NPD',
    'depends': ['base', 'npd_debt_tracking_baankhiew'],
    'data': [
