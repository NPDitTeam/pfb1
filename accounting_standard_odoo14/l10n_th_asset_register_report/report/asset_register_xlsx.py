...
class AssetRegisterExportXslx(models.AbstractModel):
        ...
        asset_template = {
            ...
            '03_date_start': {
                ...
                'data': {
                    ...
                    'type': 'datetime',
                    'format': FORMATS["format_tcell_date_left"],#self.format_tcell_date_left,
                },
                'width': 13,
            },
            '04_purchase_value': {
                ...
                'data': {
                    ...
                    'type': 'number',
                    'format': FORMATS["format_tcell_amount_right"],#self.format_tcell_amount_right,
                },
                'width': 15,
            },
            '05_accumulated_bf': {
    ...
    def _assets_report(self, workbook, ws, ws_params, data, assets):
        ...
        row_pos = self._write_line(
            ws, row_pos, ws_params, col_specs_section='header',
            default_format=FORMATS["format_theader_yellow_center"])
