odoo.define("pfb_stock_onhand.stock_onhand_report_backend", function (require) {
    "use strict";
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            "click .o_stock_onhand_reports_print": "print",
            "click .o_stock_onhand_reports_export": "export",
        },
    ...
    core.action_registry.add("stock_onhand_report_backend", report_backend);
