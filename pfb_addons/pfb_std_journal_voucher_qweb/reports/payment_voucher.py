...
class PFBVoucherQweb(models.Model):
    _name = "pfb.voucher.qweb"
...
class PaymentVoucherForm(models.AbstractModel):
    _name = 'report.pfb_std_journal_voucher_qweb.payment_voucher_pdf'
...
class ReceiptVoucherForm(models.AbstractModel):
    _name = 'report.pfb_std_journal_voucher_qweb.receipt_voucher_pdf'
