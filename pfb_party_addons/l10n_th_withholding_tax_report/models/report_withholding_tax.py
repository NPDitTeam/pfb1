...
class WithHoldingTaxReport(models.TransientModel):
    ...
    def _create_text(self, docs):
        ...
        for obj in docs:
            ...
            for idx, line in enumerate(obj.results):
                ...
                if line.cert_id.supplier_partner_id.company_type == 'person':
                    text += "{}|" \
                            "{}|" \
                            "{}|" \
                            "{}|" \
                    ...
                    "",
                    line.cert_id.supplier_partner_id.firstname or "",
                    line.cert_id.supplier_partner_id.lastname or "")
                else:
                    text += "{}|" \
                            "{}|" \
                            "{}|" \
                ...
                text += "{}|" \
                    ...
                    # ),
                    # line.cert_id.supplier_partner_id.name,
                    # line.cert_id.supplier_partner_id.lastname,
                    #line.cert_id.supplier_partner_id.display_name or "",
                    line.cert_id.supplier_partner_id.street and
                    "{} {} {} {} {}".format(line.cert_id.supplier_partner_id.street or "",
                    ...
                    line.cert_id.supplier_partner_id.zip or "") or "",
                     "",
                    self.format_date_dmy(line.cert_id.date),
                    line.wt_cert_income_desc or "",
                    "{:,.2f}".format(line.wt_percent) or 0.00,
    ...
    def _compute_results(self):
        ...
        if self.is_cheque_payment:
            domain = domain + [
                ("cert_id.payment_id.type","=","cheque"),
                ("cert_id.payment_id.cheque_id.state","in",["draft",'assigned'])
                ]
