...
def extra_global_vals(env):
    ...
    return {
        'user': env.user, 'company_id': company, 'lang': env.lang, 'time': tools.safe_eval.time, 'env': env, 'date': date,
        'timezone': timezone, 'datetime': tools.safe_eval.datetime, 'dateutil': tools.safe_eval.dateutil,
