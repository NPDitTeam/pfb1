...
class InsFinancialReport(models.TransientModel):
    ...
    def _compute_account_balance(self, accounts, report):
        ...
        if accounts:
            if self.account_report_id != \
                        self.env.ref('account_dynamic_reports_custom.ins_account_financial_report_cash_flow0') and self.strict_range:
    ...
    def _compute_report_balance(self, reports):
        ...
        for report in reports:
            ...
            if report.type == 'accounts':
                ...
                if self.account_report_id != \
                        self.env.ref('account_dynamic_reports_custom.ins_account_financial_report_cash_flow0'):
                    ...
                    for key, value in res2.items():
                        if report in [self.env.ref('account_dynamic_reports_custom.ins_cash_in_operation_1'),
                                        self.env.ref('account_dynamic_reports_custom.ins_cash_in_investing_1'),
                                      self.env.ref('account_dynamic_reports_custom.ins_cash_in_financial_1')]:
                ...
                if self.account_report_id != \
                    ...
                    if report == self.env.ref('account_dynamic_reports_custom.ins_account_financial_report_cash_flow0'):
    ...
    def get_report_values(self):
        ...
        data['form'] = self.read(
            ['date_from', 'enable_filter', 'debit_credit', 'date_to', 'date_range',
             ...
             'analytic_ids', 'analytic_tag_ids', 'department_id', 'strict_range',
        ...
        used_context['department_id'] = self.department_id
        ...
        comparison_context['department_id'] = self.department_id
        ...
        if self.account_report_id == \
            ...
            data['form']['rtype'] = 'CASH'
                ...
                self.env.ref('account_dynamic_reports_custom.ins_account_financial_report_profitandloss0'):
    ...
    def _get_default_report_id(self):
        ...
        return self.env.ref('account_dynamic_reports_custom.ins_account_financial_report_profitandloss0').id
    ...
    def action_pdf(self):
        ...
        return self.env.ref(
            'account_dynamic_reports_custom.ins_financial_report_pdf').report_action(self,
                                                                     data)
