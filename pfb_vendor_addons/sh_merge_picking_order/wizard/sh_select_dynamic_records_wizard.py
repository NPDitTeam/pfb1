                ...
                for current_record in active_ids:
                    ...
                    if messages_data:
                        ...
                        if record_id and record_id.name:
                            ...
                            message = _(
                                'This Message is From <a href=# data-oe-model=%(model)s data-oe-id=%(id)d>%(title)s</a>',
                                model=self.env.context.get('active_model'), id=record_id.id, title=html_escape(record_id.display_name))
                            record_name.append(
                                record_id.name)
